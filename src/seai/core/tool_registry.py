...
import httpx
from .net import web_search as ws_func
...
from .tools import grep_execute, glob_execute, edit_execute, bash_execute, todo_execute
...
class ToolRegistry(ToolExecutor):
    ...
    def _register_defaults(self):
        ...
        self.register("web_search", lambda args: ws_func(args.get("query",""), args.get("max_results",5)), "联网搜索", {"type":"object","properties":{"query":{"type":"string"},"max_results":{"type":"integer"}},"required":["query"]})
